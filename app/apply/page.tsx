        ...
        <div className="max-w-md mx-auto flex items-center justify-center min-h-[80vh]">
          <div className="landing-card rounded-2xl shadow-2xl p-8 text-center border w-full">
            ...
            <p className="landing-text-secondary mb-6">
              Thank you for your interest in the CEO Gála 2026. We have received your application and will review it shortly.
            </p>
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="text-center mb-8">
          <Link href="/" className="inline-block hover:opacity-80 transition-opacity">
            <h1 className="font-display text-4xl font-bold landing-text-heading mb-2">CEO Gála 2026</h1>
          </Link>
