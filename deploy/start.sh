...
echo "  1. Teszt adatok:     node scripts/seed-production.js"
echo "     VAGY admin user:  node scripts/create-admin.js"
echo "  2. Nginx beállítása: bash deploy/setup-nginx.sh"
echo "  3. SSL tanúsítvány:  bash deploy/setup-ssl.sh"
echo ""
