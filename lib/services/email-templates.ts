...
Event website: ceogala.com`,
  ...
  invitation_reminder_v2: {
    slug: 'invitation_reminder_v2',
    name: 'Invitation Reminder V2',
    subject: 'CEO Gala 2026 – Kindly Confirm Your Attendance',
    variables: ['guestName', 'magicLinkUrl', 'baseUrl'],
    html_body: `<!DOCTYPE html>
<html lang="en" xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
<head>
  ...
  <![endif]-->
  <title>CEO Gala 2026 – Kindly Confirm Your Attendance</title>
</head>
<body style="margin: 0; padding: 0; background-color: #ffffff; font-family: Verdana, Geneva, sans-serif; font-size: 15px; line-height: 1.6; color: #333333;">
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color: #ffffff;">
    <tr>
        ...
        <table role="presentation" width="680" cellpadding="0" cellspacing="0" border="0" style="max-width: 680px; width: 100%;">
          ...
          <tr>
            <td style="padding: 20px 15px; text-align: center;">
              ...
              <p style="margin: 0 0 12px 0; font-size: 15px; line-height: 1.6; color: #333333; text-align: center; font-family: Verdana, Geneva, sans-serif;">hosted at Corinthia Hotel Budapest on Friday, March 27, 2026.</p>

              <!-- NEW: Registration link convenience -->
              <p style="margin: 0 0 18px 0; font-size: 15px; line-height: 1.6; color: #333333; text-align: center; font-family: Verdana, Geneva, sans-serif;"><strong>Please find below the confirmed registration link for your convenience.</strong></p>
              ...
              <p style="margin: 0 0 12px 0; font-size: 15px; line-height: 1.6; color: #333333; text-align: center; font-family: Verdana, Geneva, sans-serif;">To confirm your attendance, please click the REGISTRATION button now. If you already know that you will not be able to attend, we would also appreciate it if you could kindly indicate your non-attendance <strong>via the same link</strong>.</p>
              ...
              <!-- Details Section - UPDATED with arrival/start times -->
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin: 20px 0;">
                <tr>
                  <td align="center" style="padding: 3px 0; font-size: 15px; line-height: 1.6; color: #333333; font-family: Verdana, Geneva, sans-serif;"><strong>Date:</strong></td>
                </tr>
                <tr>
                  <td align="center" style="padding: 3px 0; font-size: 15px; line-height: 1.6; color: #333333; font-family: Verdana, Geneva, sans-serif;">Friday, March 27, 2026,</td>
                </tr>
                <tr>
                  <td align="center" style="padding: 3px 0; font-size: 15px; line-height: 1.6; color: #333333; font-family: Verdana, Geneva, sans-serif;">Arrival from 6:30 p.m.</td>
                </tr>
                <tr>
                  <td align="center" style="padding: 3px 0; font-size: 15px; line-height: 1.6; color: #333333; font-family: Verdana, Geneva, sans-serif;">Gala programme starts: 7:00 p.m.</td>
                </tr>
                <tr><td style="padding: 8px 0;"></td></tr>
                <tr>
                  <td align="center" style="padding: 3px 0; font-size: 15px; line-height: 1.6; color: #333333; font-family: Verdana, Geneva, sans-serif;"><strong>Location:</strong> The Grand Ballroom of the Corinthia Hotel Budapest</td>
    ...
    text_body: `CEO Gala 2026 – Kindly Confirm Your Attendance
...
Please find below the confirmed registration link for your convenience.

As this is a limited-capacity event, we wanted to share a gentle reminder that registrations are filling up quickly, and we will need to close registration soon.

Your presence would mean a great deal to us, and we would truly regret having to celebrate the evening without you.

To confirm your attendance, please click the REGISTRATION link now. If you already know that you will not be able to attend, we would also appreciate it if you could kindly indicate your non-attendance via the same link.
...
Gala programme starts: 7:00 p.m.
...
Event website: ceogala.com`,
  ...
  sponsor_invitation: {
    slug: 'sponsor_invitation',
    name: 'Sponsor Invitation (PwC Hungary)',
    subject: 'Invitation to the CEO Gala 2026',
    variables: ['guestName', 'magicLinkUrl', 'baseUrl'],
    html_body: `<!DOCTYPE html>
<html lang="en" xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
        ...
        <table role="presentation" width="680" cellpadding="0" cellspacing="0" border="0" style="max-width: 680px; width: 100%;">
          ...
          <tr>
            <td style="padding: 20px 15px; text-align: center;">
              ...
              <!-- Sponsor intro -->
              <p style="margin: 0 0 12px 0; font-size: 15px; line-height: 1.6; color: #333333; text-align: center; font-family: Verdana, Geneva, sans-serif;"><strong>PwC Hungary</strong> is pleased to invite you to the CEO Gala 2026 and to host you at our corporate table.</p>

              <!-- Event description -->
              <p style="margin: 0 0 12px 0; font-size: 15px; line-height: 1.6; color: #333333; text-align: center; font-family: Verdana, Geneva, sans-serif;">The Budapest Business Journal and its official event partner, the <strong>Hungarian Investment Promotion Agency (HIPA)</strong>, are organising this highly prestigious event, the official <strong>CEO Gala 2026</strong> hosted at <strong>Corinthia Hotel Budapest on Friday, March 27, 2026.</strong></p>
              ...
              <p style="margin: 0 0 12px 0; font-size: 15px; line-height: 1.6; color: #333333; text-align: center; font-family: Verdana, Geneva, sans-serif;">If you wish to reserve your place at the gala, click the registration button below.</p>
              ...
              <!-- Sponsor personal invitation (underlined) -->
              <p style="margin: 0 0 12px 0; font-size: 15px; line-height: 1.6; color: #333333; text-align: center; font-family: Verdana, Geneva, sans-serif; text-decoration: underline;">PwC Hungary is pleased to extend this personal invitation to you for the CEO Gala 2026. We would be delighted to host you at the PwC corporate table during the event. This invitation is personal and intended exclusively for the addressee.</p>

              <!-- Registration notes -->
              <p style="margin: 0 0 12px 0; font-size: 15px; line-height: 1.6; color: #333333; text-align: center; font-family: Verdana, Geneva, sans-serif;">Due to the event's popularity and the limited seating, early registration is strongly recommended to ensure participation. When you register, please let us know if you have any special dietary requirements. We will send you a feedback email after successful registration. Please kindly note that your registration will only be finalised after having the official confirmation received.</p>
...
PwC Hungary is pleased to invite you to the CEO Gala 2026 and to host you at our corporate table.

The Budapest Business Journal and its official event partner, the Hungarian Investment Promotion Agency (HIPA), are organising this highly prestigious event, the official CEO Gala 2026 hosted at Corinthia Hotel Budapest on Friday, March 27, 2026.
...
If you wish to reserve your place at the gala, click the REGISTRATION link below.

>>> REGISTRATION: {{magicLinkUrl}} <<<

PwC Hungary is pleased to extend this personal invitation to you for the CEO Gala 2026. We would be delighted to host you at the PwC corporate table during the event. This invitation is personal and intended exclusively for the addressee.

Due to the event's popularity and the limited seating, early registration is strongly recommended to ensure participation. When you register, please let us know if you have any special dietary requirements. We will send you a feedback email after successful registration. Please kindly note that your registration will only be finalised after having the official confirmation received.
...
<head>
  ...
  <![endif]-->
  <title>Invitation to the CBRE Corporate Table</title>
</head>
<body style="margin: 0; padding: 0; background-color: #ffffff; font-family: Verdana, Geneva, sans-serif; font-size: 15px; line-height: 1.6; color: #333333;">
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color: #ffffff;">
    <tr>
      <td align="center" style="padding: 0;">
        <table role="presentation" width="680" cellpadding="0" cellspacing="0" border="0" style="max-width: 680px; width: 100%;">
          ...
          <tr>
            <td style="padding: 20px 15px; text-align: center;">
              <!-- Greeting -->
              <p style="margin: 0 0 18px 0; font-size: 15px; line-height: 1.6; color: #333333; text-align: center; font-family: Verdana, Geneva, sans-serif;">Dear <strong>{{guestTitle}} {{guestName}}</strong>,</p>

              <!-- Sponsor intro -->
              <p style="margin: 0 0 12px 0; font-size: 15px; line-height: 1.6; color: #333333; text-align: center; font-family: Verdana, Geneva, sans-serif;"><strong>CBRE</strong> is pleased to invite you to the CEO Gala 2026 and to host you at our corporate table.</p>
              ...
              <!-- Sponsor personal invitation (underlined) -->
              <p style="margin: 0 0 12px 0; font-size: 15px; line-height: 1.6; color: #333333; text-align: center; font-family: Verdana, Geneva, sans-serif; text-decoration: underline;"><strong>CBRE</strong> is pleased to extend this personal invitation to you for the CEO Gala 2026. We would be delighted to host you at the <strong>CBRE</strong> corporate table during the event. This invitation is personal and intended exclusively for the addressee.</p>
    ...
    text_body: `Invitation to the CBRE Corporate Table

Dear {{guestTitle}} {{guestName}},

CBRE is pleased to invite you to the CEO Gala 2026 and to host you at our corporate table.
...
CBRE is pleased to extend this personal invitation to you for the CEO Gala 2026. We would be delighted to host you at the CBRE corporate table during the event. This invitation is personal and intended exclusively for the addressee.
...
www.ceogala.com - event@bbj.hu`,
  ...
  reminder_1month: {
    slug: 'reminder_1month',
    name: 'Reminder 1 Month',
      ...
      <td align="center" style="padding: 0;">
        <table role="presentation" width="680" cellpadding="0" cellspacing="0" border="0" style="max-width: 680px; width: 100%;">
          ...
          <tr>
            <td style="padding: 20px 15px; text-align: center;">
              <!-- Greeting -->
              <p style="margin: 0 0 18px 0; font-size: 15px; line-height: 1.6; color: #333333; text-align: center; font-family: Verdana, Geneva, sans-serif;">Dear {{guestTitle}} <strong>{{guestName}}</strong>,</p>
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin: 20px 0;">
                <tr>
                  <td align="center" style="padding: 3px 0; font-size: 15px; line-height: 1.6; color: #333333; font-family: Verdana, Geneva, sans-serif;"><strong>The programme begins at 7:00 p.m.</strong></td>
                </tr>
                <tr>
                  <td align="center" style="padding: 3px 0; font-size: 15px; line-height: 1.6; color: #333333; font-family: Verdana, Geneva, sans-serif;"><strong>Arrival from 6:30 p.m.</strong></td>
                </tr>
              </table>
              ...
              <table role="presentation" width="680" cellpadding="0" cellspacing="0" border="0" style="margin: 30px auto; max-width: 680px;">
                <tr>
                  <td width="130" align="center" valign="middle" style="padding: 0;">
                    <a href="https://www.corinthia.com/budapest/" style="text-decoration: none;"><img src="{{baseUrl}}/email-assets/corinthia-hotel-budapest-logo.png" alt="Corinthia Hotel Budapest" width="130" style="width: 130px; height: auto; border: 0; display: block;" /></a>
                  </td>
                  <td width="90" style="font-size: 1px; line-height: 1px;">&nbsp;</td>
                  <td width="240" align="center" valign="middle" style="padding: 0;">
                    <a href="https://bbj.hu" style="text-decoration: none;"><img src="{{baseUrl}}/email-assets/bbj-logo.png" alt="Budapest Business Journal" width="240" style="width: 240px; height: auto; border: 0; display: block;" /></a>
                  </td>
                  <td width="90" style="font-size: 1px; line-height: 1px;">&nbsp;</td>
                  <td width="130" align="center" valign="middle" style="padding: 0;">
                    <a href="http://littleminds.hu" style="text-decoration: none;"><img src="{{baseUrl}}/email-assets/little-minds-logo.png" alt="Little Minds" width="130" style="width: 130px; height: auto; border: 0; display: block;" /></a>
                  </td>
                </tr>
              </table>
              <!-- Divider -->
...
Little Minds provides trusted babysitting services for executive families. Should this be helpful for you on the evening of the event, you may contact them directly via their website: http://littleminds.hu
        ...
        <table role="presentation" width="680" cellpadding="0" cellspacing="0" border="0" style="max-width: 680px; width: 100%;">
          ...
          <tr>
            <td style="padding: 20px 15px; text-align: center;">
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin: 20px 0;">
                <tr>
                  <td align="center" style="padding: 3px 0; font-size: 15px; line-height: 1.6; color: #333333; font-family: Verdana, Geneva, sans-serif;"><strong>Date:</strong> Friday, March 27</td>
                </tr>
                <tr><td style="padding: 8px 0;"></td></tr>
                <tr>
                  <td align="center" style="padding: 3px 0; font-size: 15px; line-height: 1.6; color: #333333; font-family: Verdana, Geneva, sans-serif;"><strong>Arrival from:</strong> 6:30 p.m.</td>
                </tr>
                <tr><td style="padding: 8px 0;"></td></tr>
                <tr>
                  <td align="center" style="padding: 3px 0; font-size: 15px; line-height: 1.6; color: #333333; font-family: Verdana, Geneva, sans-serif;"><strong>Venue:</strong> Grand Ballroom, Corinthia Hotel Budapest</td>
              ...
              <p style="margin: 0 0 12px 0; font-size: 15px; line-height: 1.6; color: #333333; text-align: center; font-family: Verdana, Geneva, sans-serif;">The opening ceremony will commence at <strong>7:45 p.m. sharp.</strong> We kindly recommend arriving by <strong>7:30 p.m.</strong> at the latest.</p>

              <p style="margin: 0 0 12px 0; font-size: 15px; line-height: 1.6; color: #333333; text-align: center; font-family: Verdana, Geneva, sans-serif;"><strong>Dress code:</strong> Black tie for gentlemen; evening gown or cocktail dress for ladies</p>

              <p style="margin: 0 0 12px 0; font-size: 15px; line-height: 1.6; color: #333333; text-align: center; font-family: Verdana, Geneva, sans-serif;"><strong>Parking:</strong> Limited parking is available at the hotel for a fee. We recommend using taxi services where possible for your convenience.</p>

              <p style="margin: 0 0 12px 0; font-size: 15px; line-height: 1.6; color: #333333; text-align: center; font-family: Verdana, Geneva, sans-serif;">For further details, please visit:<br><a href="https://www.ceogala.com" style="color: #333333; text-decoration: underline;"><strong>ceogala.com</strong></a></p>

              <p style="margin: 0 0 12px 0; font-size: 15px; line-height: 1.6; color: #333333; text-align: center; font-family: Verdana, Geneva, sans-serif;">Please keep in mind that any failure on your part to provide due cancellation notice may result in your being charged a no-show fee of <strong>HUF 99,000 + VAT</strong> per person.</p>

              <p style="margin: 0 0 12px 0; font-size: 15px; line-height: 1.6; color: #333333; text-align: center; font-family: Verdana, Geneva, sans-serif;">Your personal QR code will be required for entry, so please have it ready upon arrival, either on your mobile device or in printed format.</p>

              <p style="margin: 0 0 12px 0; font-size: 15px; line-height: 1.6; color: #333333; text-align: center; font-family: Verdana, Geneva, sans-serif;">You may find your personal QR code below.</p>

              <p style="margin: 0 0 12px 0; font-size: 15px; line-height: 1.6; color: #333333; text-align: center; font-family: Verdana, Geneva, sans-serif;">We very much look forward to welcoming you and sharing an exceptional evening with our CEO community.</p>
...
The opening ceremony will commence at 7:45 p.m. sharp. We kindly recommend arriving by 7:30 p.m. at the latest.

Dress code: Black tie for gentlemen; evening gown or cocktail dress for ladies

Parking: Limited parking is available at the hotel for a fee. We recommend using taxi services where possible for your convenience.

For further details, please visit: ceogala.com

Please keep in mind that any failure on your part to provide due cancellation notice may result in your being charged a no-show fee of HUF 99,000 + VAT per person.

Your personal QR code will be required for entry, so please have it ready upon arrival, either on your mobile device or in printed format.

You may find your personal QR code below.

We very much look forward to welcoming you and sharing an exceptional evening with our CEO community.
        ...
        <table role="presentation" width="680" cellpadding="0" cellspacing="0" border="0" style="max-width: 680px; width: 100%;">
          ...
          <tr>
            <td style="padding: 20px 15px; text-align: center;">
              ...
              <p style="margin: 0 0 12px 0; font-size: 15px; line-height: 1.6; color: #333333; text-align: center; font-family: Verdana, Geneva, sans-serif;">As our special guest, we look forward to welcoming you to the <strong>VIP Welcome Reception</strong> ahead of the programme.</p>

              <p style="margin: 0 0 12px 0; font-size: 15px; line-height: 1.6; color: #333333; text-align: center; font-family: Verdana, Geneva, sans-serif;">The reception begins at <strong>6:30 p.m. sharp</strong> and ends at <strong>7:00 p.m.</strong>; we kindly ask for your punctual arrival. The Gala opening ceremony will start at <strong>7:45 p.m.</strong></p>

              <!-- Details Section -->
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin: 20px 0;">
                <tr>
                  <td align="center" style="padding: 3px 0; font-size: 15px; line-height: 1.6; color: #333333; font-family: Verdana, Geneva, sans-serif;"><strong>Event date:</strong> Friday, March 27, 2026</td>
                </tr>
                <tr><td style="padding: 8px 0;"></td></tr>
                <tr>
                  <td align="center" style="padding: 3px 0; font-size: 15px; line-height: 1.6; color: #333333; font-family: Verdana, Geneva, sans-serif;"><strong>Venue:</strong> Grand Ballroom, Corinthia Hotel Budapest</td>
                ...
                <tr><td style="padding: 8px 0;"></td></tr>
                <tr>
                  <td align="center" style="padding: 3px 0; font-size: 15px; line-height: 1.6; color: #333333; font-family: Verdana, Geneva, sans-serif;"><strong>Dress code:</strong> Black tie for gentlemen; evening gown or cocktail dress for ladies</td>
                </tr>
              </table>

              <p style="margin: 0 0 12px 0; font-size: 15px; line-height: 1.6; color: #333333; text-align: center; font-family: Verdana, Geneva, sans-serif;"><strong>Parking:</strong> Limited parking is available at the hotel for a fee. We recommend using taxi services where possible for your convenience.</p>

              <p style="margin: 0 0 12px 0; font-size: 15px; line-height: 1.6; color: #333333; text-align: center; font-family: Verdana, Geneva, sans-serif;">We look forward to welcoming you and celebrating dedication, vision, and exemplary contributions to leadership together with our CEO community.</p>

              <p style="margin: 0 0 12px 0; font-size: 15px; line-height: 1.6; color: #333333; text-align: center; font-family: Verdana, Geneva, sans-serif;">Attached below is your personal QR code, which will grant you access to the gala. Please note that this personal invitation is dedicated to the addressee and is not transferable.</p>
...
As our special guest, we look forward to welcoming you to the VIP Welcome Reception ahead of the programme.

The reception begins at 6:30 p.m. sharp and ends at 7:00 p.m.; we kindly ask for your punctual arrival. The Gala opening ceremony will start at 7:45 p.m.
...
We look forward to welcoming you and celebrating dedication, vision, and exemplary contributions to leadership together with our CEO community.
